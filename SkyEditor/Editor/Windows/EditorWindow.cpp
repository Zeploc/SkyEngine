...
EditorWindow::EditorWindow(std::string InWindowName, THardPointer<CEngineWindow> InLinkedWindow, SVector2 InSize, SVector2 InPosition)
...
void EditorWindow::SetupUI()
{
	if (LinkedWindow == EditorWindowManager::GetMainWindow())
	{
		...
		//
		// //20, Size.y - 20.0f
		// THardPointer<UIButton> TestBtn(new UIButton(glm::vec2(0.0f, 0.0f), EANCHOR::TOP_LEFT, 0.0f, glm::vec4(0.3f, 0.3f, 0.3f, 1.0f), glm::vec4(0.7f, 0.7f, 0.7f, 1.0f), Size.X - 35, 30, nullptr));
		//
		...
		//
		// THardPointer<UIButton> PopoutButton(new UIButton(glm::vec2(Size.X, 0.0f), EANCHOR::TOP_RIGHT, 0.0f, glm::vec4(0.3f, 0.3f, 0.3f, 1.0f), glm::vec4(0.7f, 0.7f, 0.7f, 1.0f), 30, 30, nullptr));
		//
...
void EditorWindow::UpdateWindow()
{
	...
	// for (THardPointer<UIElement> UIElement : UIElements)
	// {
