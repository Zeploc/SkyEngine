...
private:
	...
	// Singleton
public:
	static TSharedPointer<SoundManager> GetInstance();
...
private:
	static TSharedPointer<SoundManager> m_pSoundManager;

	SoundManager();

	SoundManager(const SoundManager&); // Don't Implement
	void operator=(const SoundManager&); // Don't implement
};
