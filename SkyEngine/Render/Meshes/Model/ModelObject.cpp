...
void ModelObject::loadModel(string path)
{
...
ModelMesh ModelObject::processMesh(aiMesh* mesh, const aiScene* scene)
{
	// Data to fill
...
vector<MeshTexture> ModelObject::loadMaterialTextures(aiMaterial* mat, aiTextureType type, string typeName)
{
	vector<MeshTexture> textures;
...
GLint ModelObject::TextureFromFile(const char* path, string directory)
{
	//Generate texture ID and load texture data 
	string filename = string(path);
	filename = directory + '/' + filename;

	CLogManager::Get()->DisplayMessage("Loading model with texture at filename: " + filename);
