...
#--Return--#: 		NA
************************************************************/
ParticleSystem::ParticleSystem(STransform _Transform)
: Entity(_Transform, "Particle System")
{
...
void ParticleSystem::DrawEntity()
{
	...
	TSharedPointer<Camera> ViewportCamera = ViewportCanvas->GetViewportCamera();
